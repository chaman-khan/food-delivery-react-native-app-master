...
import { View, Text, StyleSheet, Animated, TouchableOpacity,Image,ScrollView,LogBox} from 'react-native';
...
const Favourite = ({ navigation }) => {
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            <TopMenu title='Cart' onPress={() => navigation.goBack()} />
            <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                <Image style={{ marginTop: 4 }} source={require('../Images/ath.png')} />
                <Text style={{ paddingBottom: 5 }}>   swipe on an item to delete</Text>
            </View>
            <SwipeListView
                data={listData}
                ...
                rightOpenValue={-140}
            />
            <FormButton buttonTitle='Complete Order' onPress={()=>navigation.navigate('Search')}/>
        </ScrollView>
    );
};
